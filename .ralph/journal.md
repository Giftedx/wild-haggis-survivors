...
| 2026-04-13 | 17 | BUILD | Investigate 2×P0 HUD bugs from ui review | Done — both FALSE POSITIVES. Phaser's destroy() removes listeners internally. TweenManager.shutdown() kills all tweens on scene restart. One-shot tweens self-complete in <500ms. |
