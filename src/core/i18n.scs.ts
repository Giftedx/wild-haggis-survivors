...
export const SCS_STRINGS: LocaleTree = {
  ...
  // boon labels. Individual node names fall through to EN for now; a
  // future pass can author Scots names once the feature has bedded in
  // (SCS→EN fence permits EN-only node keys; only `ui.banter.*`
  // requires EN→SCS parity).
  nodes: {
    ui: {
