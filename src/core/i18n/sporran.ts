...
export const sporran = {
  ...
  /** Chronicle row hover summaries — compact, factual run-history copy. */
  chronicle: {
    unknown_name: 'Old charm',
    unknown_effect: 'ink faded',
    effect: {
      curse_heavy_legs: 'slower hooves',
      curse_thin_hide: 'harder hits',
      curse_restless_spirits: 'quicker spawns',
      curse_empty_larder: 'less starting heart',
      curse_windless_pipes: 'slower weapons',
      boon_shortbread: '+20 HP',
      boon_whisky: 'easier spawns',
      boon_coal: 'softer hits',
      boon_silver: '+10% gold',
      quirk_light_step: 'quicker, frailer',
      quirk_hardy_breath: 'more heart, slower stride',
      quirk_haggis_blooded: 'more bite, hotter hits',
      hearth_kettle_on: '+18 HP',
      hearth_grans_shawl: 'softer hits, slower hooves',
      hearth_banked_ember: 'faster weapons, less heart',
      rare_taxman_grudge: '+20% gold, less heart',
      rare_witchs_thread: '+14% damage, +14% taken',
      seasonal_burns_dram: '+20 HP, +5% damage',
      seasonal_samhain_lantern: '+15 HP, easier spawns',
      seasonal_hogmanay_coal: 'faster weapons, bites back',
      seasonal_beltane_spark: '+12% damage, less heart',
      seasonal_st_andrews_saltire: 'quicker hooves, softer scrapes',
      variant_cailleach_frost: '+8% damage, slower stride',
      variant_glaswegian_buckie: '+6% damage, +6% taken',
      variant_witch_hare_familiar: '+10% damage, less heart',
      variant_selkie_sealskin: '+9% speed, slower weapons',
    },
  },
} as const;
