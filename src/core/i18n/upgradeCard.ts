export const upgradeCard = {
  ...
  add_steam_engine: {
    name: 'Steam Engine',
    description: 'Clyde-built pressure burst — heavy knockback. Shorter range than Coastal Storm, faster cycle.',
  },
  add_copper_rivet: {
    name: 'Copper Rivet',
  ...
  add_port_a_beul: {
    name: 'Port-à-Beul',
    description: 'Vocal-percussion aura — slows enemies near you. On the beat, the slow bites harder.',
  },
  add_highland_trump: {
    name: 'Highland Trump',
