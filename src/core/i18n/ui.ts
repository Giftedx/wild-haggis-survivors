export const ui = {
  ...
  menu: {
    ...
    challenges: '↗ FRIEND CHALLENGES ({n})',
    challenges_panel_title: 'FRIEND CHALLENGES',
    challenges_none: 'Nae challenges received yet.\nShare a run and send the link tae a friend.',
    challenges_beat: 'beat {time}',
    challenges_outlast: 'outlast {time}',
    challenges_beaten: 'Beaten ✓',
    challenges_pending: 'Try it →',
    challenges_attempts: '{n} attempt(s)',
    challenges_close: '✕ close',
    chronicle: 'CHRONICLE',
    deeds: 'YIR DEEDS',
    almanac: 'ALMANAC',
  ...
  almanac: {
     ...
     *  8 entries unlocked by fieldNotesLifetime thresholds [1,3,7,12,20,30,50,75].
     *  Pompous faux-naturalist voice; the joke is that the Foundation writes in
     *  officious English while the haggis answers in Scots. */
    find_cat_foundation: 'FOUNDATION',
    foundation: {
  ...
  cairn: {
    ...
    whisper: {
      past_self: {
        ...
        moor_runner: 'A haggis fell here. Ran too far ahead of itself.',
        iron_belly: 'A haggis fell here. Took more than its share and kept going.',
        glen_forager: 'A haggis fell here. Still gathering when the moor was done.',
        surefoot: 'A haggis fell here. Sure-footed right until it wasn\'t.',
        pipe_breath: 'A haggis fell here. The breath left the pipes before the piper.',
        wee_ghostie: 'A haggis fell here. Or perhaps it didn\'t. Hard to tell with this one.',
        laird: 'A haggis fell here. The estate did not follow.',
        anticlockwise: 'A haggis fell here. Went round the other way. Same end.',
        peerie_shetlander: 'A haggis fell here, on the voar moor. Peerie, but no\' easily forgotten.',
        witch_hare: '"I sall gang intil a hare." This is where it went.',
        selkie: 'A haggis fell here on the tidal edge. The pelt stayed.',
      },
    },
    grandfather: {
  ...
  banter: {
    ...
    biome_change: {
      ...
      bog: {
        ...
        e: 'Reeds whisperin\' at shin height. Polite, for reeds.',
      },
      loch: {
        ...
        e: 'A gull laughed. That\'s either warning or manners.',
      },
      pine: {
        ...
        e: 'Pine cones everywhere. Wee wooden caltrops.',
      },
      heather: {
        ...
        e: 'Purple bloom underhoof. Looks soft. Isnae always.',
      },
      coastal: {
        ...
        e: 'Kelp on the stones. Slippy wee ribbon, that.',
      },
      haar: {
        ...
        e: 'Fog\'s tucked the horizon in. Cosy liar.',
      },
      frost: {
        ...
        e: 'Ice in the hoofprints. Even the mud\'s gone quiet.',
      },
      cairngorm: {
    ...
    moor_moment: {
      ...
      // B5-B11 biome sub-pools. 4 lines each, hearth register.
      coastal: {
        a: 'Salt luck — the tide checked yer pocket.',
        b: 'Surf tipped a coin. The shore keeps its promises.',
        c: 'Tern wheeled right — good omen, that.',
        d: 'Atlantic paid its dues. Cold-handed but fair.',
      },
      haar: {
        a: 'Fog parted just enough — grey generosity.',
        b: 'Haar made space for something kind. Brief but real.',
        c: 'Mist remembered ye — offered a wee boon in the quiet.',
        d: 'The haar opened a lane. Dinnae dawdle.',
      },
      frost: {
        a: 'Ice cracked lucky — the cold has manners.',
        b: 'Hoarfrost shone a coin yer way. Accept it.',
        c: 'Crystal air — a winter gift, nae strings attached.',
        d: 'Frost paid interest. Rare honour in a cauld biome.',
      },
      cairngorm: {
        a: 'Plateau blinked — brief grace at altitude.',
        b: 'Scree moved aside. The Cairngorms dinnae always.',
        c: 'High air tipped a boon doon. Braw.',
        d: 'Mountain luck — thin air, generous moment.',
      },
      glen_coe: {
        a: 'The glen offered something, quiet-like.',
        b: 'Rock gave a gift — the Coe remembers its ain.',
        c: 'The pass gave one favour. Accept it wi respect.',
        d: 'History moved aside a moment. Rare, that.',
      },
      clyde_shipyard: {
        a: 'Rivet-luck — the yard still builds fer ye.',
        b: 'Clyde gave an ounce — no invoice to follow.',
        c: 'Caulk-money. Honest wage from honest ground.',
        d: 'A shipwright\'s nod — fair work earns fair luck.',
      },
      black_bog: {
        a: 'Dark peat offered something. Accept without questions.',
        b: 'The black gave a gift. Best nae ask what\'s in it.',
        c: 'Ink-water paid. Even the deep has its debts.',
        d: 'Compressed fortune — the black pressured it out fer ye.',
      },
      ben_nevis: {
        a: 'The Ben paid ye. That\'s unusual. Take it.',
        b: 'Summit wind shared a moment — brisk, brief, meant.',
        c: 'Highest ground, kindest moment. Make it worth the climb.',
        d: 'The plateau blinked. Altitude favour.',
      },
      glasgow_close: {
        a: 'Close-mouth luck — somebody left it out fer ye.',
        b: 'Sodium-amber gift. Glesga pays its ain.',
        c: 'The close gave — nae fuss, nae fanfare.',
        d: 'Urban boon. The tenement looked out fer ye.',
      },
      fingals_cave: {
        a: 'Basalt rang lucky — the cave approves.',
        b: 'Atlantic chord — the columns paid their dues.',
        c: 'Cave echo carried a gift in — perfect pitch.',
        d: 'Stone gave back. The Staffa debt, finally.',
      },
      callanish: {
        a: 'The stones noticed. Rare, and kindly.',
        b: 'Ancient luck — older than the asking.',
        c: 'Stone-ring grace. Nae words, just a gift.',
        d: 'The alignment approved. Brief nod frae the Neolithic.',
      },
      trossachs: {
        a: 'Oak blessed — the Trossachs like ye.',
        b: 'Rob Roy country gives what it can. Quietly.',
        c: 'Birch touched luck into yer path.',
        d: 'Forest floor offered. Damp, but sincere.',
      },
      edinburgh_old_town: {
        a: 'Gaslit gift — the close stepped aside fer ye.',
        b: 'Tenement luck. Edinburgh disnae give often.',
        c: 'Cobble turned kind — accept, dinnae look doon.',
        d: 'The Old Town tipped its cap. Mind it.',
      },
      cairngorm_woods: {
        a: 'Caledonian pine gave a wee nod.',
        b: 'Auld wood favoured ye. Ancient courtesy.',
        c: 'Forest floor stirred — a gift from below.',
        d: 'Pine dropped luck on ye. Nae charge.',
      },
      orkney: {
        a: 'Wind gave — and Orkney wind disnae give often.',
        b: 'Stone and sea — the oldest ground paid its tithe.',
        c: 'Atlantic-scoured luck. Clean, and yers.',
        d: 'The Ring o\' Brodgar looked yer way. Briefly.',
      },
      corryvreckan: {
        a: 'Maelstrom paused — offered something instead.',
        b: 'The whirlpool gave. Dinnae ask how.',
        c: 'Even the corry blinks sometimes. Catch the grace.',
        d: 'The deep turned generous. No warning, no reason.',
      },
      shetland_voe: {
        a: 'Simmer dim gave — soft and gold.',
        b: 'Da voe smiled. Norse fortune, yers the day.',
        c: 'Puffin rock agreed. Shetland approves.',
        d: 'Long light, loose luck. Simmer dim gift.',
      },
      skye_fairy_pool: {
        a: 'Pool blinked — the fey felt generous.',
        b: 'Mineral luck — the Cuillin asked no fee.',
        c: 'The water tipped a wee gift. Fey-quiet.',
        d: 'Something in the pool gave. Dinnae ask who.',
      },
      hebridean_shore: {
        a: 'Machair offered — soft ground, Atlantic gift.',
        b: 'Grey seal looked yer way. That counts as luck here.',
        c: 'Shore light carried a wee boon in.',
        d: 'The Hebrides paid — wind, salt, and something kind.',
      },
      calton_hill: {
        a: 'Bonfire gave a blessing — Beltane debts paid.',
