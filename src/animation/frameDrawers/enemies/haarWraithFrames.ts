/**
 * Haar Wraith — floating fog-spirit frame definitions.
 *
...
import { drawHaarWraithBody, HAAR_WRAITH_CANVAS_SIZE } from '../../../art/sprites/enemies/haarWraith';
...
export const haarWraithDrawer: EnemyFrameDrawer = {
  enemyKey: 'haar_wraith',
  canvasSize: HAAR_WRAITH_CANVAS_SIZE,
  ...
  draw(g: Phaser.GameObjects.Graphics, frame: EnemyBodyFrame): void {
    drawHaarWraithBody(g, frame);
  },
};

// Self-register on module load — BootScene imports this file.
registerEnemyFrameDrawer(haarWraithDrawer);
