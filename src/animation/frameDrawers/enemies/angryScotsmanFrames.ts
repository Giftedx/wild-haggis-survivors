/**
 * Angry Scotsman — chase archetype frame definitions.
 *
 * 4 authored states (idle, walking, hurt, dying). Attacking and
 * celebrating fall back to idle_0 — enemies don't use those states.
 *
 * The scotsman's walk is a heavy-footed charge — kilt swinging,
 * barrel chest heaving with fury.
 */
...
const FRAMES: FrameTable = {
  idle: [
    { breathY: 1 },   // breathing in — chest heaves
...
export const angryScotsmanDrawer: EnemyFrameDrawer = {
  enemyKey: 'angry_scotsman',
...
registerEnemyFrameDrawer(angryScotsmanDrawer);
