/**
 * Blue Man of Minch — ranged archetype frame definitions.
 *
 * 4 authored states (idle, walking, hurt, dying). Floating/ethereal
 * (waist-deep in water, no visible legs) — bodyX + breathY only.
 */

import type { AnimationState } from '../../animationStates';
import type { EnemyBodyFrame, EnemyFrameDrawer } from './enemyFrameTypes';
import { drawBlueManOfMinchBody, BLUE_MAN_OF_MINCH_CANVAS_SIZE } from '../../../art/sprites/enemies/blueManOfMinch';
...
export const blueManOfMinchDrawer: EnemyFrameDrawer = {
  enemyKey: 'blue_man_of_minch',
  canvasSize: BLUE_MAN_OF_MINCH_CANVAS_SIZE,
  ...
  draw(g: Phaser.GameObjects.Graphics, frame: EnemyBodyFrame): void {
    drawBlueManOfMinchBody(g, frame);
  },
};

// Self-register on module load — BootScene imports this file.
registerEnemyFrameDrawer(blueManOfMinchDrawer);
