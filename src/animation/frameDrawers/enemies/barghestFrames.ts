/**
 * Barghest — phantom hound frame definitions.
 *
 * 4 authored states (idle, walking, hurt, dying). Animal with legs
 * (front pair = leftLegY, back pair = rightLegY). Gentler offsets
 * than humanoids — low-slung hound doesn't stride wide.
 */

import type { AnimationState } from '../../animationStates';
import type { EnemyBodyFrame, EnemyFrameDrawer } from './enemyFrameTypes';
import { drawBarghestBody, BARGHEST_CANVAS_SIZE } from '../../../art/sprites/enemies/barghest';
...
export const barghestDrawer: EnemyFrameDrawer = {
  enemyKey: 'barghest',
  canvasSize: BARGHEST_CANVAS_SIZE,
  ...
  draw(g: Phaser.GameObjects.Graphics, frame: EnemyBodyFrame): void {
    drawBarghestBody(g, frame);
  },
};

// Self-register on module load — BootScene imports this file.
registerEnemyFrameDrawer(barghestDrawer);
