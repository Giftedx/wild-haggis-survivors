/**
 * Ledger Wraith — floating clerk-spirit frame definitions.
 *
...
import { drawLedgerWraithBody, LEDGER_WRAITH_CANVAS_SIZE } from '../../../art/sprites/enemies/ledgerWraith';
...
export const ledgerWraithDrawer: EnemyFrameDrawer = {
  enemyKey: 'ledger_wraith',
  canvasSize: LEDGER_WRAITH_CANVAS_SIZE,
  ...
  draw(g: Phaser.GameObjects.Graphics, frame: EnemyBodyFrame): void {
    drawLedgerWraithBody(g, frame);
  },
};

// Self-register on module load — BootScene imports this file.
registerEnemyFrameDrawer(ledgerWraithDrawer);
