/**
 * Tourist — chase archetype frame definitions.
 *
 * 4 authored states (idle, walking, hurt, dying). Attacking and
 * celebrating fall back to idle_0 — enemies don't use those states.
 *
 * The tourist's walk is a bewildered shuffle — slightly wider stance,
 * unsteady. The shopping bag sways.
 */

import type { AnimationState } from '../../animationStates';
import type { EnemyBodyFrame, EnemyFrameDrawer } from './enemyFrameTypes';
import { drawTouristBody, TOURIST_CANVAS_SIZE } from '../../../art/sprites/enemies/tourist';
...
export const touristDrawer: EnemyFrameDrawer = {
  enemyKey: 'tourist',
  canvasSize: TOURIST_CANVAS_SIZE,
  ...
  draw(g: Phaser.GameObjects.Graphics, frame: EnemyBodyFrame): void {
    drawTouristBody(g, frame);
  },
};

// Self-register on module load — BootScene imports this file.
registerEnemyFrameDrawer(touristDrawer);
