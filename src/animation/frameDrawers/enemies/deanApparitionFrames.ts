/**
 * Dean Apparition — floating academic ghost frame definitions.
 *
...
import { drawDeanApparitionBody, DEAN_APPARITION_CANVAS_SIZE } from '../../../art/sprites/enemies/deanApparition';
...
export const deanApparitionDrawer: EnemyFrameDrawer = {
  enemyKey: 'dean_apparition',
  canvasSize: DEAN_APPARITION_CANVAS_SIZE,
  ...
  draw(g: Phaser.GameObjects.Graphics, frame: EnemyBodyFrame): void {
    drawDeanApparitionBody(g, frame);
  },
};

// Self-register on module load — BootScene imports this file.
registerEnemyFrameDrawer(deanApparitionDrawer);
