/**
 * Tourist Ghost — floating ghost minion frame definitions.
 *
 ...
 * Drifts like the ghost parent archetype; slightly jerkier (tourist panic).
 */

import type { AnimationState } from '../../animationStates';
import type { EnemyBodyFrame, EnemyFrameDrawer } from './enemyFrameTypes';
import { drawTouristGhostBody, TOURIST_GHOST_CANVAS_SIZE } from '../../../art/sprites/enemies/touristGhost';
...
const FRAMES: FrameTable = {
  ...
  dying: [
    { breathY: 2 },               // sinks
    { breathY: 4, bodyX: 1 },    // sinking further
    { breathY: 6 },              // fades down
  ],
};
...
export const touristGhostDrawer: EnemyFrameDrawer = {
  enemyKey: 'tourist_ghost',
  canvasSize: TOURIST_GHOST_CANVAS_SIZE,
  ...
  draw(g: Phaser.GameObjects.Graphics, frame: EnemyBodyFrame): void {
    drawTouristGhostBody(g, frame);
  },
};

// Self-register on module load — BootScene imports this file.
registerEnemyFrameDrawer(touristGhostDrawer);
