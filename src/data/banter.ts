...
export const BANTER_POOLS: readonly BanterPool[] = [
  ...
  },
  {
    ...
    keysByTag: {
      ...
      clarsach: [
        'ui.banter.weapon_evolve.clarsach.a',
        'ui.banter.weapon_evolve.clarsach.b',
        'ui.banter.weapon_evolve.clarsach.c',
        'ui.banter.weapon_evolve.clarsach.d',
      ],
      hagstone_sling: [
        'ui.banter.weapon_evolve.rowan_hail.a',
        'ui.banter.weapon_evolve.rowan_hail.b',
  ...
  },
  {
    ...
    keysByTag: {
      ...
      heather: [
        ...
        'ui.banter.biome_change.heather.e',
      ],
      coastal: [
        ...
        'ui.banter.biome_change.coastal.e',
      ],
      haar: [
      ...
      frost: [
        ...
        'ui.banter.biome_change.frost.e',
      ],
  ...
  },
  {
    ...
    keysByTag: {
      ...
      // B5+ biome sub-pools — 4 lines each, hearth register. The generic
      // a-z pool fires when no tag matches; these surface when a moor
      // moment fires in the matching biome, adding atmosphere.
      coastal: [
        'ui.banter.moor_moment.coastal.a',
        'ui.banter.moor_moment.coastal.b',
        'ui.banter.moor_moment.coastal.c',
        'ui.banter.moor_moment.coastal.d',
      ],
      haar: [
        'ui.banter.moor_moment.haar.a',
        'ui.banter.moor_moment.haar.b',
        'ui.banter.moor_moment.haar.c',
        'ui.banter.moor_moment.haar.d',
      ],
      frost: [
        'ui.banter.moor_moment.frost.a',
        'ui.banter.moor_moment.frost.b',
        'ui.banter.moor_moment.frost.c',
        'ui.banter.moor_moment.frost.d',
      ],
      cairngorm: [
        'ui.banter.moor_moment.cairngorm.a',
        'ui.banter.moor_moment.cairngorm.b',
        'ui.banter.moor_moment.cairngorm.c',
        'ui.banter.moor_moment.cairngorm.d',
      ],
      glen_coe: [
        'ui.banter.moor_moment.glen_coe.a',
        'ui.banter.moor_moment.glen_coe.b',
        'ui.banter.moor_moment.glen_coe.c',
        'ui.banter.moor_moment.glen_coe.d',
      ],
      clyde_shipyard: [
        'ui.banter.moor_moment.clyde_shipyard.a',
        'ui.banter.moor_moment.clyde_shipyard.b',
        'ui.banter.moor_moment.clyde_shipyard.c',
        'ui.banter.moor_moment.clyde_shipyard.d',
      ],
      black_bog: [
        'ui.banter.moor_moment.black_bog.a',
        'ui.banter.moor_moment.black_bog.b',
        'ui.banter.moor_moment.black_bog.c',
        'ui.banter.moor_moment.black_bog.d',
      ],
      ben_nevis: [
        'ui.banter.moor_moment.ben_nevis.a',
        'ui.banter.moor_moment.ben_nevis.b',
        'ui.banter.moor_moment.ben_nevis.c',
        'ui.banter.moor_moment.ben_nevis.d',
      ],
      glasgow_close: [
        'ui.banter.moor_moment.glasgow_close.a',
        'ui.banter.moor_moment.glasgow_close.b',
        'ui.banter.moor_moment.glasgow_close.c',
        'ui.banter.moor_moment.glasgow_close.d',
      ],
      fingals_cave: [
        'ui.banter.moor_moment.fingals_cave.a',
        'ui.banter.moor_moment.fingals_cave.b',
        'ui.banter.moor_moment.fingals_cave.c',
        'ui.banter.moor_moment.fingals_cave.d',
      ],
      callanish: [
        'ui.banter.moor_moment.callanish.a',
        'ui.banter.moor_moment.callanish.b',
        'ui.banter.moor_moment.callanish.c',
        'ui.banter.moor_moment.callanish.d',
      ],
      trossachs: [
        'ui.banter.moor_moment.trossachs.a',
        'ui.banter.moor_moment.trossachs.b',
        'ui.banter.moor_moment.trossachs.c',
        'ui.banter.moor_moment.trossachs.d',
      ],
      edinburgh_old_town: [
        'ui.banter.moor_moment.edinburgh_old_town.a',
        'ui.banter.moor_moment.edinburgh_old_town.b',
        'ui.banter.moor_moment.edinburgh_old_town.c',
        'ui.banter.moor_moment.edinburgh_old_town.d',
      ],
      cairngorm_woods: [
        'ui.banter.moor_moment.cairngorm_woods.a',
        'ui.banter.moor_moment.cairngorm_woods.b',
        'ui.banter.moor_moment.cairngorm_woods.c',
        'ui.banter.moor_moment.cairngorm_woods.d',
      ],
      orkney: [
        'ui.banter.moor_moment.orkney.a',
        'ui.banter.moor_moment.orkney.b',
        'ui.banter.moor_moment.orkney.c',
        'ui.banter.moor_moment.orkney.d',
      ],
      corryvreckan: [
        'ui.banter.moor_moment.corryvreckan.a',
        'ui.banter.moor_moment.corryvreckan.b',
        'ui.banter.moor_moment.corryvreckan.c',
        'ui.banter.moor_moment.corryvreckan.d',
      ],
      shetland_voe: [
        'ui.banter.moor_moment.shetland_voe.a',
        'ui.banter.moor_moment.shetland_voe.b',
        'ui.banter.moor_moment.shetland_voe.c',
        'ui.banter.moor_moment.shetland_voe.d',
      ],
      skye_fairy_pool: [
        'ui.banter.moor_moment.skye_fairy_pool.a',
        'ui.banter.moor_moment.skye_fairy_pool.b',
        'ui.banter.moor_moment.skye_fairy_pool.c',
        'ui.banter.moor_moment.skye_fairy_pool.d',
      ],
      hebridean_shore: [
        'ui.banter.moor_moment.hebridean_shore.a',
        'ui.banter.moor_moment.hebridean_shore.b',
        'ui.banter.moor_moment.hebridean_shore.c',
        'ui.banter.moor_moment.hebridean_shore.d',
      ],
      calton_hill: [
        'ui.banter.moor_moment.calton_hill.a',
  ...
  // gran_commentary 30→28, enemy_ambient 40→41, burns_citation 45→43.
  {
    ...
    keysByTag: {
      ...
      highland_games: [
        'ui.banter.seasonal_event.highland_games.a',
        'ui.banter.seasonal_event.highland_games.b',
        'ui.banter.seasonal_event.highland_games.c',
        'ui.banter.seasonal_event.highland_games.d',
        'ui.banter.seasonal_event.highland_games.e',
        'ui.banter.seasonal_event.highland_games.f',
        'ui.banter.seasonal_event.highland_games.g',
        'ui.banter.seasonal_event.highland_games.h',
        'ui.banter.seasonal_event.highland_games.i',
        'ui.banter.seasonal_event.highland_games.j',
        'ui.banter.seasonal_event.highland_games.k',
        'ui.banter.seasonal_event.highland_games.l',
      ],
    },
  },
