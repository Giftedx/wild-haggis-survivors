...
const LOC_BUDGET: ReadonlyArray<readonly [string, number]> = [
  ...
  ['systems/WeaponSystem.ts', 1450], // bumped 2026-05-09 (1415→1450) for Sgian Dubh weapon (DESIGN_IDEAS §5 — arc_sweep dispatch fork + sgian visual branch (cold steel wedge) + sgian_geal evolution case (forced-crit via effectiveDamage forceCrit param)); current 1437 + 13 grace; orchestrator, no obvious sub-system seams. Earlier bumps same day: 1385→1415 (Shinty Stick weapon), 1360→1385 (Taxman Grudge Ledger emit)
