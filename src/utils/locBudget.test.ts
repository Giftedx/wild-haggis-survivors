...
const LOC_BUDGET: ReadonlyArray<readonly [string, number]> = [
  ...
  ['scenes/GameScene.ts', 1830], // bumped 2026-05-09 (1790→1830) for Sporran Deck Phase 1 wiring (DESIGN_IDEAS §1 — pendingSporranIds field + sporranRunStart import + buildSporranRunStartPlan call block + applySporranRunStartPostSpawn call block; helper itself extracted to game/sporranRunStart.ts so most of the wiring lives outside GameScene.ts); current 1817 + 13 grace. Earlier same-day: 1740→1790 for Lemmings Easter Egg wiring (DESIGN_IDEAS §13 — lemmingsEasterEgg field + LemmingsEasterEgg ctor block + reset deps + setter); was 2985 → 2182 → 1680 (Phase 7 re-baseline); T401 floor 1656
