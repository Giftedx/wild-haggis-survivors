...
const LOC_BUDGET: ReadonlyArray<readonly [string, number]> = [
  ...
  ['scenes/GameScene.ts', 2420], // was 2432 (Phase 5 Bucket 6 partial — installRunEndComposers extracted: RunExitComposer + RunHistoryRecorder + RunPersistenceCoordinator de-duped through one opts bag; current 2413 + 7 grace)
  ['data/banter.ts', 2240],
