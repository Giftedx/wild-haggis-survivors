...
const LOC_BUDGET: ReadonlyArray<readonly [string, number]> = [
  ...
  ['data/banter.ts', 2670], // bumped 2026-05-09 (2620→2670) for field_note_pickup pool (DESIGN_IDEAS §11 Haggis Wildlife Foundation field notes — context union member + pool entry, hearth tone, priority 44, six naturalist-voice leaves; sister-pool to reliquary_pick at 45); current 2658 + 12 grace; pure data, parity-fenced, kept whole. Earlier bumps same day: 2565→2620 (beithir_sting), 2535→2565 (lemmings_remember), 2490→2535 (taxman_grudge), 2455→2490 (clootie_wager), 2430→2455 (shinty_parry), 2400→2430 (stance_change), 2375→2400 (simmer_dim seasonal)
