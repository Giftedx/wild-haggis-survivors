...
const LOC_BUDGET: ReadonlyArray<readonly [string, number]> = [
  ...
  ['scenes/GameScene.ts', 2432], // was 2433 (Phase 5 Bucket 1 partial — installWorldDressing extracted: flora / wildlife / mist construction with ordered RNG branches; current 2425 + 7 grace)
  ['data/banter.ts', 2240],
