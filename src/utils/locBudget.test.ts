...
const LOC_BUDGET: ReadonlyArray<readonly [string, number]> = [
  ...
  ['scenes/GameScene.ts', 2269], // was 2285 (Phase 5 Bucket 6 finish — installRunBookkeeping: MoorMomentScheduler + RunPersistenceBridge + BossHpTracker + DebugTimeTravelApi extracted; current 2263 + 6 grace)
  ['data/banter.ts', 2240],
