...
const LOC_BUDGET: ReadonlyArray<readonly [string, number]> = [
  ...
  ['scenes/GameScene.ts', 2405], // was 2420 (Phase 5 Bucket 10 partial — installRuntimeAmbient extracted: AmbientWeather + Hazards + GameTickers + PickupSpawner; current 2398 + 7 grace)
  ['data/banter.ts', 2240],
