...
const LOC_BUDGET: ReadonlyArray<readonly [string, number]> = [
  ...
  ['scenes/GameScene.ts', 2252], // was 2269 (Phase 5 Bucket 5d — tickPresentationFrame: bossHp + edgeIndicators + minimap + relicPins + music compositor + dash/boundary tickers extracted to runtimeTickHooks; current 2246 + 6 grace)
  ['data/banter.ts', 2240],
