...
const LOC_BUDGET: ReadonlyArray<readonly [string, number]> = [
  ...
  ['scenes/GameScene.ts', 2450], // was 2483 (Phase 5 Bucket 7 partial — wireWeaponSystemListeners extracted: enemyKilled / damageDealt / projectileTrail / weaponFired listeners; current 2443 + 7 grace)
  ['data/banter.ts', 2240],
