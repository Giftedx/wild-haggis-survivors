...
- ~~**B5 Phase 3 Edinburgh biome**~~ — ✅ shipped 2026-05-27 (`edinburgh_old_town`, tint 0x5a5060, `edinburghSmoke`: -10% speed / +12% XP, hazard: `cobble_gap`). Also shipped same day: `calton_hill` (Beltane Fire Festival, B11). Full 24-biome roster now live; EN + SCS i18n + banter + wee tales complete for all 24.
