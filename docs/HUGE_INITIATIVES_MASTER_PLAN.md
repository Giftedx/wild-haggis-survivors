...
W2, W66, and T1 shipped. Next pick from the parking lot below. **W18** (bilingual Scots/English) banter pool is the natural follow-up — the act-intermission pattern and the Chronicle route log are both fully i18n-ready; the banter pool needs voice-register review. Pending stakeholder selection.
