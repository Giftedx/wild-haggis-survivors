...
- ~~**Sporran Deck Phase 2.**~~ ✅ Shipped 2026-05-10. Phase 2 chronicle persistence + v19 save migration + v4 replay blob in `e183bcb`. Phase 3 pool 12→18 with deed/seasonal/variant gates in `f514cb8`. Pip-strip hover tooltip in `1c3dd31`. Spec at `docs/archive/superpowers/specs/2026-05-10-sporran-deck-phase2-design.md`.
