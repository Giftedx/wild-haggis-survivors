...
| **W71** Skeletal animation rig | 🟡 Phase 0 prototype shipped 2026-04-22; Phase 1 enemy animation + Phase 2 secondary motion shipped 2026-04-23. **2026-05-28: all gameplay enemies animated** — 19 boss frame drawers + beithir + 5 minion/swarm drawers (midge, midgie_swarm, nest, tourist_ghost, spectre_legionary). Remaining without drawers: `auld_reekie` (architectural blocker — non-square canvas). `berserker` ✅ 2026-05-28. `deep_fryer` ✅ 2026-05-28 (idle-only 2-frame oil-pressure bob; `drawDeepFryerBody` extracted from `bakeDeepFryer`). |
