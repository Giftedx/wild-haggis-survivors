...
| **W71** Skeletal animation rig | 🟡 Phase 0 prototype shipped 2026-04-22; Phase 1 enemy animation + Phase 2 secondary motion shipped 2026-04-23. **2026-05-28: all gameplay enemies animated** — 19 boss frame drawers + beithir + 5 minion/swarm drawers (midge, midgie_swarm, nest, tourist_ghost, spectre_legionary). All gameplay enemies now animated. `berserker` ✅ `deep_fryer` ✅ `auld_reekie` ✅ (all three landed 2026-05-28; `auld_reekie` required square-canvas refactor from 48×56 → 60×60). |
