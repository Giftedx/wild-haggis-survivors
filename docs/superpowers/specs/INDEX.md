...
| **P3** Cloud saves | [2026-04-26-cloud-save-conflict-ux-design](2026-04-26-cloud-save-conflict-ux-design.md) | (cross-cuts; no single plan file) | [adr/0006-cloud-save-backend](../../adr/0006-cloud-save-backend.md) + [P3_BACKEND_DECISION_MATRIX.md](../../P3_BACKEND_DECISION_MATRIX.md) — Architectural decision Accepted 2026-05-09; humans-in-the-loop legal/ops work still open |
...
| **W18** Moor renders itself (Phase 0 prototype) | [2026-04-18-moor-renders-itself-design](2026-04-18-moor-renders-itself-design.md) | [2026-04-18-moor-phase-0-prototype-plan](../plans/2026-04-18-moor-phase-0-prototype-plan.md) | shipped — see [PHASE_0_GATE_NOTES.md](../../PHASE_0_GATE_NOTES.md) |
...
| **W71** Animation rig (Phase 0 + 2) | [2026-04-23-secondary-motion-design](2026-04-23-secondary-motion-design.md) (Phase 2) | [2026-04-23-secondary-motion](../plans/2026-04-23-secondary-motion.md) | [adr/0005](../../adr/0005-skeletal-animation-rig.md) + [PHASE_0_GATE_NOTES.md](../../PHASE_0_GATE_NOTES.md) — Phase 0+2 shipped, Phase 1 partial |
...
| **S1** Sporran Deck (pre-run draft) | [2026-05-09-sporran-deck-design](2026-05-09-sporran-deck-design.md) + [2026-05-10-sporran-deck-phase2-design](2026-05-10-sporran-deck-phase2-design.md) | [2026-05-09-sporran-deck-phase0](../plans/2026-05-09-sporran-deck-phase0.md) | Phase 0 + 1 + 1.5 SHIPPED 2026-05-09→10 (`eabe2a6` helper + `6275720` UI + `a5043e5` 12th card + `d3221b8` DOM-focus mirror). Phase 2 (chronicle persistence + replay-side pick replay; save v18→v19; replay blob v3→v4) drafted 2026-05-10 — ready to dispatch. Memory `project_sporran_deck_status`. |
