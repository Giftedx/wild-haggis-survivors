...
2. **Bucket 1: Rune system controller** — single helper, 180-LOC yield, no UI surface, low blast radius. Start here.
3. **Bucket 2: Moor moments** — five small helpers, 180-LOC yield, light gameplay touch.
