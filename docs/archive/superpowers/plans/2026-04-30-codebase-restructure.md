...
> **STATUS (2026-05-09):** Phases 0–7 SHIPPED. GameScene 2874→1672 LOC across 30+ helper extractions; Phase 7 re-baseline locks the ratchet at 1680 (T401 floor 1656 honoured). GameOverScene 1310→292; SettingsScene 1350→677; HUD 1222→1097; JuiceSystem 1374→1059. Reaching T401 charter target ≤1200 requires the formal facade rewrite (Combat / Progression / Nodes / Persistence) explicitly out of scope here. See `docs/superpowers/specs/2026-04-30-gamescene-regrowth-audit.md` for the bucket-by-bucket trail and `docs/LOC_BUDGET.md` for the locked floor.
>
